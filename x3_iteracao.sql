...
CREATE TABLE `iteracao` (
  `cod_sprint` int NOT NULL AUTO_INCREMENT,
  `cod_projeto_fk` int NOT NULL,
  `nome` varchar(50) NOT NULL,
  `descricao` varchar(255) NOT NULL,
  `dt_inicio` datetime NOT NULL,
  `dt_fim` datetime NOT NULL,
  PRIMARY KEY (`cod_sprint`,`cod_projeto_fk`),
  KEY `cod_projeto_fk` (`cod_projeto_fk`),
  CONSTRAINT `iteracao_ibfk_1` FOREIGN KEY (`cod_projeto_fk`) REFERENCES `projeto` (`cod_projeto`)
